...
describe('PATCH /todos/:id', () => {
  it('should update the todo', (done) => {
    ...
    request(app)
      ...
      .set('x-auth', users[0].tokens[0].token)
      .send({
        text: 'updated first todo from testcase',
        completed: true,
      })
      .expect(200)
      .expect((res) => {
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    ...
    request(app)
      ...
      .set('x-auth', users[1].tokens[0].token)
      .send({
        text: 'updated second todo from testcase',
        completed: false,
      })
      .expect(200)
      .expect((res) => {
...
describe('GET /users/me', () => {
  ...
  it('should return a 401 if not authencated', (done) => {
    request(app)
      .get('/users/me')
      .expect(401)
      .expect((res) => {
...
describe('POST /users', () => {
  ...
  it('should not create user if email in use', (done) => {
    request(app)
      .post('/users')
      .send({
        email: 'avadh.vashisth@gmail.com',
        password: 'abcde12345',
      })
      .expect(400)
      .end(done);
